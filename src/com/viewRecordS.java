...
public class viewRecordS extends JFrame implements viewRecordInterface{
	 	static viewRecordS viewRecordS;
	    String id;
	    ...
	    public viewRecordS(String id) throws SQLException {
	        this.id = id;
	        initComponents();
	        displayResults();
	    }
	    ...
	    public void displayResults() throws SQLException {
	        ...
	        rs.first();
	            ...
	            //testing result here
	            //TODO insert into the textfields
